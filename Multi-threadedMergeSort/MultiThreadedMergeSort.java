...
public class MultiThreadedMergeSort {
    ...
    public static void PMergeSort(int[] A, int p, int r, int[] B, int s) {
        ...
        if (n == 1) {
            ...
            Thread thread1 = new Thread(() -> {
                PMergeSort(A, pValue, q1Value, T, 0);
            });
    ...
    public static void PMerge(int[] T, int p1, int r1, int p2, int r2, int[] A, int p3) {
        ...
        if (n1 == 0) {
            ...
            final int r2Value = r2; // Create final local variable for r2

            Thread thread1 = new Thread(() -> {
                PMerge(T, p1Value, q1Value - 1, p2Value, r2Value - 1, A, p3Value); // Use r2Value inside lambda
            });

            Thread thread2 = new Thread(() -> {
                PMerge(T, q1Value + 1, r1Value, q2Value, r2Value, A, q3 + 1); // Use r2Value inside lambda
            });
